        ...
        <div className="flex flex-col p-6 md:p-0  ">
            <div className="max-w-7xl mx-auto w-full md:h-full md:flex md:flex-col md:px-6">
                ...
                <header className="flex justify-between items-center py-4">
                    <h2 className="flex flex-row gap-2 font-bold text-lg items-center">
                        <div className="rounded-full border-2  border-accent w-8 h-8 bg-accent/10 flex items-center justify-center ">
                            <svg
                                xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-accent" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 11a2 2 0 1 1-4 0 4 4 0 0 1 8 0 6 6 0 0 1-12 0 8 8 0 0 1 16 0 10 10 0 1 1-20 0 11.93 11.93 0 0 1 2.42-7.22 2 2 0 1 1 3.16 2.44" />
                            </svg>
                        </div>
                ...
                <main className="grid grid-cols-1 md:grid-cols-2 w-full ">
                    ...
                    <div className="flex flex-col justify-center  max-w-xl space-y-5  text-left">
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 w-full ">
                            ...
                            <div className="border border-border rounded-lg p-6 space-y-3 hover:border-accent hover:-translate-y-1 transition" >
